...
const register = (userName, firstName, lastName, email, password, seniority, workingPosition)  => {
    return {
        type: answerTypes.REGISTER_REQUEST,
        promice: () => AuthService.register(userName, firstName, lastName, email, password, seniority, workingPosition)
    }
}
